// source: colink-server-dev/proto/colink.proto
/**
 * @fileoverview
 * @enhanceable
...
goog.exportSymbol('proto.colink.RefreshTokenRequest', null, global);
 ...
 * @constructor
 */
proto.colink.RefreshTokenRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.colink.RefreshTokenRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.colink.RefreshTokenRequest.displayName = 'proto.colink.RefreshTokenRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.colink.RefreshTokenRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.colink.RefreshTokenRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.colink.RefreshTokenRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.colink.RefreshTokenRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.colink.RefreshTokenRequest}
 */
proto.colink.RefreshTokenRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.colink.RefreshTokenRequest;
  return proto.colink.RefreshTokenRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.colink.RefreshTokenRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.colink.RefreshTokenRequest}
 */
proto.colink.RefreshTokenRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.colink.RefreshTokenRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.colink.RefreshTokenRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.colink.RefreshTokenRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.colink.RefreshTokenRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.colink.RefreshTokenRequest.prototype.getExpirationTime = function() {
...
/**
 * @param {number} value
 * @return {!proto.colink.RefreshTokenRequest} returns this
 */
proto.colink.RefreshTokenRequest.prototype.setExpirationTime = function(value) {
 ...
 * @return {string}
 */
proto.colink.Participant.prototype.getPtype = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.colink.Participant} returns this
 */
proto.colink.Participant.prototype.setPtype = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
